    ...
    <div className="container mx-auto">
        {
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <button className="flex ml-auto text-white bg-orange-400 border-0 py-2 px-6 focus:outline-none hover:bg-orange-500 cursor-pointer rounded transition" onClick={() => addItemToCart(product)}>
                        {isItemAdded(product.id)
                            ? `Added (${isItemAdded(product.id).quantity})`
                            : `Add to Cart`}
                    </button>
                        <Link
                        className="rounded-full w-10 h-10 bg-gray-200 inline-flex items-center justify-center text-gray-500 ml-4"
                        to={"/cart"}>
